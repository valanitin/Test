...
use Magentizer\Pricing\Api\Data\DataSearchResultsInterfaceFactory;
use Magentizer\Pricing\Model\ResourceModel\Data as ResourceData;
use Magentizer\Pricing\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Magentizer\Pricing\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Magentizer\Pricing\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Magentizer\Pricing\Model\ResourceModel\Data\Collection $collection */
