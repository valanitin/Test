...
class Display
{
     ...
     * @return string
     */
    public function getCreditCurrency($storeId = null)
    {
        return (string)$this->scopeConfig->getValue('swarming_credits/display/credit_currency', ScopeInterface::SCOPE_STORE, $storeId);
    }
}
