...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '0.0.2') < 0) {
            $tableName = $setup->getTable('firas_activity');
        ...
        if (version_compare($context->getVersion(), '0.1.3') < 0) {
            ...
            /**
             * Create table 'firas_login_activity'
             */
            $table = $setup->getConnection()->newTable(
                $setup->getTable('firas_login_activity')
            )->addColumn(
                'entity_id',
        ...
        if (version_compare($context->getVersion(), '0.1.4') < 0) {
            $tableName = $setup->getTable('firas_login_activity');
            $connection = $setup->getConnection();
        ...
        if (version_compare($context->getVersion(), '0.1.5') < 0) {
            $tableName = $setup->getTable('firas_activity_log');
