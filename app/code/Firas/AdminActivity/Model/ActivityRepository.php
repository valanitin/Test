...
use Firas\AdminActivity\Model\Activity\SystemConfig;

/**
 * Class ActivityRepository
 * @package Firas\AdminActivity\Model
 */
class ActivityRepository implements \Firas\AdminActivity\Api\ActivityRepositoryInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(
        ...
        \Firas\AdminActivity\Model\ResourceModel\Activity\CollectionFactory $collectionFactory,
        \Firas\AdminActivity\Model\ActivityLogDetailFactory $activityLogDetailFactory,
        \Firas\AdminActivity\Model\ActivityLogFactory $activityLogFactory,
        \Firas\AdminActivity\Model\ResourceModel\ActivityLog\CollectionFactory $LogCollectionFactory,
        \Firas\AdminActivity\Model\Activity\SystemConfig $systemConfig,
        \Firas\AdminActivity\Model\Activity\ThemeConfig $themeConfig,
    ...
    public function revertActivity($activity)
    {
        ...
        if (\Firas\AdminActivity\Helper\Data::isWildCardModel($detailModel->getModelClass())) {
