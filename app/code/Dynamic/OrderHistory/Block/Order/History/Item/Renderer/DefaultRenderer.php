...
namespace Dynamic\OrderHistory\Block\Order\History\Item\Renderer;

use Magento\Sales\Model\Order\CreditMemo\Item as CreditMemoItem;
use Magento\Sales\Model\Order\Invoice\Item as InvoiceItem;
use Magento\Sales\Model\Order\Item as OrderItem;
//use Dynamic\OrderHistory\Model\OrderhistoryItem as OrderItem;
...
class DefaultRenderer extends \Magento\Framework\View\Element\Template
{
    ...
    public function getOrderItem()
    {
        ...
        //if ($this->getItem() instanceof \Dynamic\OrderHistory\Model\OrderhistoryItem) {			
            return $this->getItem();
        } else {
    ...
    {
        return 'item_row_total_after_discount';
