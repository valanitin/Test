...
namespace Firas\DonationProduct\Model\Quote\Item;

use Firas\DonationProduct\Helper\Serializer;
use Firas\DonationProduct\Model\DonationOptionsFactory;
 ...
 * @package Firas\DonationProduct\Model\Quote\Item
 */
    ...
    public function processOptions(CartItemInterface $cartItem)
    {
        ...
        if (!empty($options) && is_array($options)) {
            foreach ($options as $name => $value) {
                /** @var \Firas\DonationProduct\Model\DonationOptions $donationOptions */
