 ...
 */
namespace Firas\AdminActivity\Model\Config;
...
/**
 * Class SchemaLocator
 * @package Firas\AdminActivity\Model\Config
 */
class SchemaLocator implements SchemaLocatorInterface
{
    ...
    {
        $configDir = $moduleReader->getModuleDir(Dir::MODULE_ETC_DIR, 'Firas_AdminActivity');
