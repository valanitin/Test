...
class Processor
{
    ...
    public function __construct(
        \Firas\AdminActivity\Model\Config $config,
        \Magento\Backend\Model\Auth\Session $authSession,
        \Firas\AdminActivity\Model\Handler $handler,
        \Magento\Framework\HTTP\PhpEnvironment\RemoteAddress $remoteAddress,
        \Firas\AdminActivity\Model\ActivityFactory $activityFactory,
        \Firas\AdminActivity\Model\ActivityLogDetailFactory $activityDetailFactory,
        ...
        \Firas\AdminActivity\Model\Activity\Status $status,
        \Firas\AdminActivity\Model\Handler\PostDispatch $postDispatch
    ) {
        $this->config = $config;
    ...
    {
        if (\Firas\AdminActivity\Helper\Data::isWildCardModel($model)) {
    ...
    public function addLog($activity, $logData, $model)
    {
        ...
        $this->activityLogs[] = [
            \Firas\AdminActivity\Model\Activity::class => $activity,
            \Firas\AdminActivity\Model\ActivityLog::class => $logData,
            \Firas\AdminActivity\Model\ActivityLogDetail::class => $logDetail
        ];
    }
        ...
        try {
            if (!empty($this->activityLogs)) {
                foreach ($this->activityLogs as $model) {
                    $activity = $model[\Firas\AdminActivity\Model\Activity::class];
                    $activity->save();
                    $activityId = $activity->getId();

                    if (isset($model[\Firas\AdminActivity\Model\ActivityLog::class])) {
                        $logData = $model[\Firas\AdminActivity\Model\ActivityLog::class];
                        if ($logData) {
                    ...
                    if (isset($model[\Firas\AdminActivity\Model\ActivityLogDetail::class])) {
                        $detail = $model[\Firas\AdminActivity\Model\ActivityLogDetail::class];
