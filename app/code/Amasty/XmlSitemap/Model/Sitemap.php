...
class Sitemap extends AbstractModel implements SitemapInterface
{
    ...
    {
        return $this->_getStoreBaseUrl($type) . ltrim((string)$url, '/');
    }
    ...
    {
        return (int)$this->_getData(SitemapInterface::MAX_ITEMS);
    }

    public function setMaxItems(int $maxItems): SitemapInterface
    {
        $this->setData(SitemapInterface::MAX_ITEMS, (int)$maxItems);
    ...
    {
        $this->setData(SitemapInterface::MAX_FILE_SIZE, (int)$maxFileSize);
    ...
    {
        return (int)$this->_getData(SitemapInterface::TYPE);
    }

    public function setType(int $type): SitemapInterface
    {
        $this->setData(SitemapInterface::TYPE, (int)$type);
    ...
    {
        $this->setData(SitemapInterface::STORE_ID, (int)$storeId);
    ...
    {
        return (int)$this->_getData(SitemapInterface::CATEGORIES);
    }

    public function setCategories(int $categories): SitemapInterface
    {
        $this->setData(SitemapInterface::CATEGORIES, (int)$categories);
    ...
    {
        return (int)$this->_getData(SitemapInterface::CATEGORIES_MODIFIED);
    }

    public function setCategoriesModified(int $categoriesModified): SitemapInterface
    {
        $this->setData(SitemapInterface::CATEGORIES_MODIFIED, (int)$categoriesModified);
    ...
    {
        return (bool)$this->_getData(SitemapInterface::CATEGORIES_THUMBS);
    }

    public function setCategoriesThumbs(int $categoriesThumbs): SitemapInterface
    {
        $this->setData(SitemapInterface::CATEGORIES_THUMBS, (int)$categoriesThumbs);
    ...
    {
        return (int)$this->_getData(SitemapInterface::CATEGORIES_CAPTIONS);
    }

    public function setCategoriesCaptions(int $categoriesCaptions): SitemapInterface
    {
        $this->setData(SitemapInterface::CATEGORIES_CAPTIONS, (int)$categoriesCaptions);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PAGES);
    }

    public function setPages(int $pages): SitemapInterface
    {
        $this->setData(SitemapInterface::PAGES, (int)$pages);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PAGES_MODIFIED);
    }

    public function setPagesModified(int $pagesModified): SitemapInterface
    {
        $this->setData(SitemapInterface::PAGES_MODIFIED, (int)$pagesModified);
    ...
    {
        return (int)$this->_getData(SitemapInterface::EXTRA);
    }

    public function setExtra(int $extra): SitemapInterface
    {
        $this->setData(SitemapInterface::EXTRA, (int)$extra);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PRODUCTS);
    }

    public function setProducts(int $products): SitemapInterface
    {
        $this->setData(SitemapInterface::PRODUCTS, (int)$products);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PRODUCTS_THUMBS);
    }

    public function setProductsThumbs(int $productsThumbs): SitemapInterface
    {
        $this->setData(SitemapInterface::PRODUCTS_THUMBS, (int)$productsThumbs);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PRODUCTS_CAPTIONS);
    }

    public function setProductsCaptions(int $productsCaptions): SitemapInterface
    {
        $this->setData(SitemapInterface::PRODUCTS_CAPTIONS, (int)$productsCaptions);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PRODUCTS_MODIFIED);
    }
    ...
    {
        $this->setData(SitemapInterface::PRODUCTS_MODIFIED, (int)$productsModified);
    ...
    {
        return (int)$this->_getData(SitemapInterface::PRODUCTS_URL);
    }

    public function setProductsUrl(int $productsUrl): SitemapInterface
    {
        $this->setData(SitemapInterface::PRODUCTS_URL, (int)$productsUrl);
    ...
    {
        return (int)$this->_getData(SitemapInterface::LANDING);
    }

    public function setLanding(int $landing): SitemapInterface
    {
        $this->setData(SitemapInterface::LANDING, (int)$landing);
    ...
    {
        return (int)$this->_getData(SitemapInterface::BRANDS);
    }

    public function setBrands(int $brands): SitemapInterface
    {
        $this->setData(SitemapInterface::BRANDS, (int)$brands);
    ...
    {
        return (int )$this->_getData(SitemapInterface::BLOG);
    }

    public function setBlog(int $blog): SitemapInterface
    {
        $this->setData(SitemapInterface::BLOG, (int)$blog);
    ...
    {
        return (int)$this->_getData(SitemapInterface::NAVIGATION);
    }

    public function setNavigation(int $navigation): SitemapInterface
    {
        $this->setData(SitemapInterface::NAVIGATION, (int)$navigation);
    ...
    {
        return (int)$this->_getData(SitemapInterface::FAQ);
    }

    public function setFaq(int $faq): SitemapInterface
    {
        $this->setData(SitemapInterface::FAQ, (int)$faq);
    ...
    {
        return (int)$this->_getData(SitemapInterface::EXCLUDE_OUT_OF_STOCK);
    }

    public function setExcludeOutOfStock(int $excludeOutOfStock): SitemapInterface
    {
        $this->setData(SitemapInterface::EXCLUDE_OUT_OF_STOCK, (int)$excludeOutOfStock);
    ...
    public function setExcludeProductType(int $excludeProductType): SitemapInterface
    {
        $this->setData(SitemapInterface::EXCLUDE_PRODUCT_TYPE, (int)$excludeProductType);
