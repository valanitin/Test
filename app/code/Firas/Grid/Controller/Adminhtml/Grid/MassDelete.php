<?php
/**
 * Firas Grid Record Delete Controller.
 * @category  Firas
 * @package   Firas_Grid
 * @author    Firas
...
use Firas\Grid\Model\ResourceModel\Grid\CollectionFactory;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Firas_Grid::row_data_delete');
    }
}
