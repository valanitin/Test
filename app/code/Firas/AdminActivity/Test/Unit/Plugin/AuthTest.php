 ...
 */
namespace Firas\AdminActivity\Test\Unit\Plugin;

/**
 * Class AuthTest
 * @package Firas\AdminActivity\Test\Unit\Plugin
 */
class AuthTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->loginRepositoryMock = $this->getMockBuilder(\Firas\AdminActivity\Api\LoginRepositoryInterface
        ::class)
        ...
        $this->authTest = $objectManager->getObject(
            \Firas\AdminActivity\Plugin\Auth::class,
            [
