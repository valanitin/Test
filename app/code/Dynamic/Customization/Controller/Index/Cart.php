    ...
    { 
        ...
        $configureUrl = $this->_url->getUrl(
            ...
            [
             ...
             if($key != ""){
                 $parameters['product'] =  $item->getProductId();
                 $parameters['product_id'] =  $item->getProductId();
                 $parameters['super_attribute'] = array($key => isset($_GET['super_attribute'])?$_GET['super_attribute']:"");
             }
