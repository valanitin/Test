...
namespace Firas\DonationProduct\Plugin\Magento\Checkout\Block\Cart\Item;

use Firas\DonationProduct\Helper\Data;

/**
 * Class Renderer
 * @package Firas\DonationProduct\Plugin\Magento\Checkout\Block\Cart\Item
 */
class Renderer
{
    ...
    public function afterGetProductOptions(
        ...
        if ($typeId == \Firas\DonationProduct\Model\Product\Type\Donation::TYPE_CODE) {
