...
namespace Dynamic\Customization\Controller\Account;
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                ...
                if (!empty($login['username']) && !empty($login['password'])) {
                    ...
                    $this->customerModel->loadByEmail($login['username']);
                    $customerId = $this->customerModel->getId();

                    $resultRedirect = $this->resultRedirectFactory->create();

                    if(isset($customerId) && $customerId!= '') {
                        return $resultRedirect->setPath('customer/account/signin?type=pass');
                    }else{
                        return $resultRedirect->setPath('customer/account/signin?type=user');
                    }
