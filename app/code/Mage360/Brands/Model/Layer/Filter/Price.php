...
use Mage360\Brands\Helper\Data as LayerHelper;

/**
 * Class Price
 * @package Mage360\Brands\Model\Layer\Filter
 */
class Price extends AbstractFilter
{
    /** @var \Mage360\Brands\Helper\Data */
     ...
     * @param \Mage360\Brands\Helper\Data $moduleHelper
     * @param array $data
     */
    ...
    {
        /** @var \Mage360\Brands\Model\ResourceModel\Fulltext\Collection $productCollection */
        $productCollection = $this->getLayer()->getProductCollection();

        if ($this->_filterVal) {
            /** @type \Mage360\Brands\Model\ResourceModel\Fulltext\Collection $productCollectionClone */
