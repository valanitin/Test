...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create table 'firas_activity'
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('firas_activity')
        )->addColumn(
            'entity_id',
        ...
        /**
         * Create table 'firas_activity_log'
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('firas_activity_log')
        )->addColumn(
            'entity_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            10,
            ...
            'Entity id of firas_activity table'
        )->addColumn(
            'field_name',
            \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
            32,
            ...
            $installer->getIdxName('firas_activity', ['entity_id']),
            ['activity_id']
        )->addForeignKey(
            $installer->getFkName(
                'firas_activity_log',
        ...
        /**
         * Create table 'firas_activity_detail'
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('firas_activity_detail')
        )->addColumn(
            'entity_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            10,
