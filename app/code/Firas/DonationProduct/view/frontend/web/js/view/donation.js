define([
    ...
    $.widget('mage.donation', {
        ...
        initDonationModal: function () {
            ...
            var pMinLabel = $('.firas-donation-minimal-amount-label-' + this.options.identifier);
            ...
            $('html').on('click', this.options.productSelector, function () {
                ...
                if (charity.data('productid') != '') {
                    ...
                    $('.firas-donation-modal')
                        .modal(options)
                        .modal('openModal');

                    $('.firas-modal-popup .modal-title').text(title);
                }
            });
