...
class ActivityLogListingTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->activityRepositoryMock = $this->getMockForAbstractClass(
            \Firas\AdminActivity\Api\ActivityRepositoryInterface::class,
            [],
            '',
            false
        );

        $this->browserMock = $this->createMock(\Firas\AdminActivity\Helper\Browser::class);
        ...
        $this->activityModel = $this
            ->getMockBuilder(\Firas\AdminActivity\Model\Activity::class)
            ->setMethods(
                [
                    'getUserAgent',
                    'getUsername',
