 ...
 */
namespace Revered\GuestWishlist\Model\ResourceModel\Item;
...
/**
 * Class Collection
 * @package Revered\GuestWishlist\Model\ResourceModel\Item
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    /**
     * @var \Revered\GuestWishlist\Model\ResourceModel\Item\Option\CollectionFactory
     */
    ...
    {
        $this->_init(\Revered\GuestWishlist\Model\Item::class, \Revered\GuestWishlist\Model\ResourceModel\Item::class);
    ...
    protected function _assignOptions()
    {
        ...
        /* @var $optionCollection \Revered\GuestWishlist\Model\ResourceModel\Item\Option\Collection */
        $optionCollection = $this->_optionCollectionFactory->create();
        $optionCollection->addItemFilter($itemIds);

        /* @var $item \Revered\GuestWishlist\Model\Item */
     ...
     *
     * @param \Revered\GuestWishlist\Model\Wishlist $wishlist
     * @return $this
     */
    public function addWishlistFilter(\Revered\GuestWishlist\Model\Wishlist $wishlist)
    {
