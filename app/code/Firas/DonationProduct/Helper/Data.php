...
namespace Firas\DonationProduct\Helper;
...
/**
 * Class Data
 * @package Firas\DonationProduct\Helper
 */
class Data extends AbstractHelper
{
    ...
    const DONATION_CONFIGURATION_MINIMAL_AMOUNT = 'firas_donation_product/general/minimal_amount';

    const DONATION_CONFIGURATION_MAXIMAL_AMOUNT = 'firas_donation_product/general/maximal_amount';

    const DONATION_CONFIGURATION_FIXED_AMOUNTS = 'firas_donation_product/general/fixed_amounts';

    const DONATION_CONFIGURATION_PRODUCT_LIMIT_SIDEBAR = 'firas_donation_product/layout/sidebar_product_limit';

    const DONATION_CONFIGURATION_PRODUCT_LIMIT_HOMEPAGE = 'firas_donation_product/layout/homepage_product_limit';

    const DONATION_CONFIGURATION_PRODUCT_LIMIT_CART = 'firas_donation_product/layout/cart_product_limit';

    const DONATION_CONFIGURATION_PRODUCT_LIMIT_CHECKOUT =  'firas_donation_product/layout/checkout_product_limit';

    const DONATION_CONFIGURATION_LAYOUT_CHECKOUT_ENABLED =  'firas_donation_product/layout/checkout_enabled';

    const DONATION_CONFIGURATION_LAYOUT_CHECKOUT_SIDEBAR_ENABLED =
        'firas_donation_product/layout/checkout_sidebar_enabled';

    const DONATION_CONFIGURATION_LAYOUT_SIDEBAR_ENABLED =  'firas_donation_product/layout/sidebar_enabled';

    const DONATION_CONFIGURATION_LAYOUT_HOMEPAGE_ENABLED =  'firas_donation_product/layout/homepage_enabled';

    const DONATION_CONFIGURATION_LAYOUT_CART_ENABLED =  'firas_donation_product/layout/cart_enabled';
    ...
    {
        if ($product->getFirasDonationMinAmount()) {
            return (int) $product->getFirasDonationMinAmount();
        }
    ...
    {
        if ($product->getFirasDonationMaximalAmount()) {
            return (int) $product->getFirasDonationMaximalAmount();
        }
