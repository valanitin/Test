...
class TrackFieldTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $systemConfig = $this->getMockBuilder(\Firas\AdminActivity\Model\Activity\SystemConfig::class)
            ->disableOriginalConstructor()
            ->getMock();

        $themeConfig = $this->getMockBuilder(\Firas\AdminActivity\Model\Activity\ThemeConfig::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->helper = new \Firas\AdminActivity\Helper\TrackField(
            $context,
            $systemConfig,
            $themeConfig
        );
