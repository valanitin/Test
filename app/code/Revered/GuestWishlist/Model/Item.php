...
use Revered\GuestWishlist\Model\Item\Option;
use Revered\GuestWishlist\Model\Item\OptionFactory;
use Revered\GuestWishlist\Model\ResourceModel\Item\Option\CollectionFactory;
...
class Item extends AbstractModel implements ItemInterface
{
    ...
    public function __construct(
        ...
        $this->serializer = $serializer ? $serializer : \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Revered\GuestWishlist\Model\SerializerBridge::class);
    ...
    {
        $this->_init(\Revered\GuestWishlist\Model\ResourceModel\Item::class);
    }
