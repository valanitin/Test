...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            return $this->returnResult($resultItem, $this->relatedAdded, $product->getName(), 0);
            ...
            return $this->returnResult($resultItem, $this->relatedAdded, $product->getName(), 1);
        } catch (\Exception $e) {
     ...
     */
    private function returnResult($resultItem, $relatedAdded, $productName, $hasError = 0)
    {
        $result = [];
