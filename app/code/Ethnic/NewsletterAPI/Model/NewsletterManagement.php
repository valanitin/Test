 ...
 */
namespace Ethnic\NewsletterAPI\Model;
 ...
 * {@inheritDoc}
 */
class NewsletterManagement implements \Ethnic\NewsletterAPI\Api\NewsletterManagementInterface
{
    /**
    ...
    public function unsubscribeCustomer($email) {
        ...
        try {
            ...
            if ($subscriber->getId()
                ...
                $subscriber->save();
                $success = true;
                $message = __('This email address is success unsubscribed.');
            } else {
                $message = __('This email address is already unsubscribed.');
            }
        } catch (\Magento\Framework\Exception\LocalizedException $e) {
            $message = __('There was a problem with the unsubscription: %1', $e->getMessage());
        } catch (\Exception $e) {
            $message = __('There was a problem with the unsubscription: %1', $e->getMessage());
        }
