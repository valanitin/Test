...
namespace Firas\ProductGridCategoryFilter\Helper;

use Magento\Framework\App\Config\ScopeConfigInterface;

class Data
{
    const XML_PATH_ANCHOR_SHOW = 'catalog/firas_productgridcategoryfilter/anchor_show';
    const XML_PATH_ANCHOR_FILTER = 'catalog/firas_productgridcategoryfilter/anchor_filter';
    const XML_PATH_STORE_ID = 'catalog/firas_productgridcategoryfilter/store_id';
