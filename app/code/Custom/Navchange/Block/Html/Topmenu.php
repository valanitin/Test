...
{    /**
    ...
    * @param \Magento\Framework\Data\Tree\TreeFactory $treeFactory
    * @param array $data
    */
   ...
   protected function _getHtml(
       ...
       foreach ($children as $child) {
           ...
           if ($childLevel === 0 && $outermostClass) {
               ...
               $ttip = '<span class="tooltiptext">Click to View All '.$this->escapeHtml($child->getName()).'</span>';
           }
           $extra = '';
           if ($childLevel == 1){
                $extra = '<a href="' . $child->getUrl() . '" ' . 'class="m2cls"' . '><span style="font-size: 15px !important;
                text-transform: capitalize !important; border-bottom: none !important; color: #747070 !important; margin-left: 16px; text-decoration: none !important;">All ' . $this->escapeHtml(
                    $child->getName()
                ) . '</span></a>';
            }
           ...
           $html .= '<a href="' . $child->getUrl() . '" ' . $outermostClassCode . '><span>' . $this->escapeHtml(
               $child->getName()
           ) .$ttip. '</span></a>'.$extra . $this->_addSubMenu(
               $child,
               $childLevel,
               $childrenWrapClass,
               $limit 
